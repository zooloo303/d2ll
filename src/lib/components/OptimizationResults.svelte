<script lang="ts">
  ...
  function identifyStagingItems() {
    stagingItems = loadout.filter((item) => {
      const itemLocation = findItemInInventory(
        $inventoryStore,
        item.itemInstanceId,
      );
    ...
    <div class="grid grid-cols-5 gap-4">
      {#if selectedExotic}
        <div class="col-span-5">
          <h3 class="text-lg font-semibold mb-2">Selected Exotic</h3>
      ...
      <div class="col-span-5">
        <h3 class="text-lg font-semibold mb-2">Fragments</h3>
        <ul>
      ...
      <div class="col-span-5">
        <h3 class="text-lg font-semibold mb-2">Mods</h3>
        <ul>
          {#each mods as mod}
      ...
      <div class="col-span-5">
        <h3 class="text-lg font-semibold mb-2">Total Stats</h3>
        <ul>
